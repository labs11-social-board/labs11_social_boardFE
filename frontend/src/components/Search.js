...
class Search extends Component {
  ...
  searchCategories = () => {
    ...
    return this.setState({ loading: true }, () => {
      return axios
        .get(`${backendUrl}/categories/search`, headers)
  ...
  searchTeams = () => {
    ...
    return this.setState({ loading: true }, () => {
      return axios
        .get(`${backendUrl}/team/search`, headers)
        .then(res => this.setState({ searchResults: res.data }))
        .then(() => this.setState({ loading: false }))
        .then(() => !this.props.showSearch && this.props.toggleSearch())
        .catch(err => {
  ...
  searchDiscussions = () => {
    ...
    return this.setState({ loading: true }, () => {
      return axios
        .get(`${backendUrl}/discussions/search`, headers)
        .then(res => this.setState({ searchResults: res.data }))
        .then(() => this.setState({ loading: false }))
        .then(() => !this.props.showSearch && this.props.toggleSearch())
        .catch(err => {
  ...
  searchPosts = () => {
    ...
    return this.setState({ loading: true }, () => {
      return axios
        .get(`${backendUrl}/posts/search`, headers)
        .then(res => this.setState({ searchResults: res.data }))
        .then(() => this.setState({ loading: false }))
        .then(() => !this.props.showSearch && this.props.toggleSearch())
        .catch(err => {
  ...
  searchAll = () => {
    ...
    return this.setState({ loading: true }, () => {
      return axios
        .get(`${backendUrl}/users/search-all`, headers)
        .then(res => this.setState({ searchResults: res.data }))
        .then(() => this.setState({ loading: false }))
        .then(() => !this.props.showSearch && this.props.toggleSearch())
        .catch(err => {
  ...
  handleInputChange = e => {
    return this.setState(
      { [e.target.name]: e.target.value, searchResults: [] },
      () => {
        ...
        if (searchBy === all && order !== created_at) {
          return this.setState({ order: created_at }, () =>
            this.handleSearch()
          );
        }
        return this.handleSearch();
