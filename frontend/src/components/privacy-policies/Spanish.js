...
const SpanishPrivacyPolicy = () => {
	return(
		<div>
			...
			<p>Fecha efectiva: February 16, 2019</p>


			<p>Symposium ("nosotros", "a nosotros", "nuestro") opera el sitio web https://symposium-frontend.netlify.com/ (en adelante, el "Servicio").</p>
			...
			<p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el https://symposium-frontend.netlify.com/</p>

			<h2>Definiciones</h2>
			<ul>
				<li>
					<p><strong>Servicio</strong></p>
							<p>Servicio es el sitio web https://symposium-frontend.netlify.com/ operado por Symposium</p>
						</li>
				<li>
			...
			<h2>Uso de datos</h2> 
			<p>Symposium utiliza los datos recopilados con diversas finalidades:</p>    
			<ul>
			...
			<ul>
					<li>Por e-mail: cornielleandres@gmail.com</li>
...
export default SpanishPrivacyPolicy;
