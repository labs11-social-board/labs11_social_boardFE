...
// action creators
import { logBackIn, markNotificationsAsRead, toggleTheme, verifyEmail } from './store/actions/index.js';
...
class App extends Component {
	...
	componentDidMount() {
		...
		if (user_id && token)
			return this.props.logBackIn(user_id, token).then(() => {
							...
							<DivPage>
								...
								{this.state.isEditProfileModalRaised && (
									<EditProfileModal
										...
										isEditProfileModalRaised={this.state.isEditProfileModalRaised}
								...
								<Route
									exact
									path="/"
									render={() => <NonUserLandingView toggleRegisterModal={this.toggleRegisterModal} />}
								/>
								<Route exact path="/home" component={LandingView} />
								<Route
									exact
									path="/admin"
									render={(props) => <Admin {...props} isDay={isDay} history={this.props.history} />}
								/>
								...
								<Route
									...
									render={(props) => (
										<Profile
											...
											setEditProfileModalRaised={this.setEditProfileModalRaised}
											isEditProfileModalRaised={this.state.isEditProfileModalRaised}
											toggleSearch={this.userToggleSearch}
											goTo={this.userGoTo}
											history={this.props.history}
											showSearch={this.state.showUsersSearch}
											setInviteFriendModalRaised={this.setInviteFriendModalRaised}
											isInviteFriendModalRaised={this.state.isInviteFriendModalRaise}
										/>
									)}
								/>
								<Route
								...
								<Route
									path="/team/posts/:id"
									render={(props) => <TeamDiscussionView {...props} scrollTo={this.scrollTo} />}
								/>
								<Route
									path="/discussion/:id"
									render={(props) => <DiscussionView {...props} scrollTo={this.scrollTo} />}
								/>
								<Route
									path="/settings/:id"
									render={(props) => (
										<Settings {...props} setChangeSubModalRaised={this.setChangeSubModalRaised} />
									)}
								/>
...
export default connect(mapStateToProps, { logBackIn, markNotificationsAsRead, toggleTheme, verifyEmail })(App);
